...
const EXAMPLE_DATA: ProtocolTrafic[] = [];
 ...
 */
export class TrafficTableProtocolDataSource extends DataSource<ProtocolTrafic> {
  data: ProtocolTrafic[] = EXAMPLE_DATA;
   ...
   */
  connect(): Observable<ProtocolTrafic[]> {
   ...
   */
  private getPagedData(data: ProtocolTrafic[]): ProtocolTrafic[] {
    if (this.paginator) {
  ...
  private getSortedData(data: ProtocolTrafic[]): ProtocolTrafic[] {
    ...
    return data.sort((a, b) => {
      ...
      switch (this.sort?.active) {
        case 'name':
          return compare(a.protocol, b.protocol, isAsc);
        case 'download':
          return compare(
